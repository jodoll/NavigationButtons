...
class BleKeyboardWrapper : public KeyboardWrapper
{
private:
...
public:
    ...
    void writeKey(const Keyboard::Key &key) override;
    void holdKey(Keyboard::Key &key) override;
    void releaseKey(Keyboard::Key &key) override;
